...
declare -a trainlist=("pomaria" "tolstoy" "shelbyville" "allensville" "wainscott" "beechwood" "coffeen")
#  "stockman" "hiteman" "woodbine" "lindenwood" "forkland" "mifflinburg" "ranchester")
...
echo "Done coffeen 18/25"


fname=../tiny-train-0.15-part2
mkdir -p $fname
