...
main_gt_out_path_1 = r'/data/multi-domain-graph-6/datasets/datasets_preproc_gt/replica/train1'
main_gt_out_path_2 = r'/data/multi-domain-graph-6/datasets/datasets_preproc_gt/replica/train2'
main_exp_out_path = r'/data/multi-domain-graph-6/datasets/datasets_preproc_exp/replica/train'
main_exp_out_path1 = r'/data/multi-domain-graph-6/datasets/datasets_preproc_exp/replica/train1'
main_exp_out_path2 = r'/data/multi-domain-graph-6/datasets/datasets_preproc_exp/replica/train2'
'''
...
VALID_EXPERTS_NAME = [
    'edges_dexined', 'saliency_seg_egnet', 'depth_xtc', 'halftone_gray_basic',
    'normals_xtc'
]
...
#                                   - 2 split train samples - gt
#                                   - 3 split train samples - exp
