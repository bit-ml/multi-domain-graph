...
class SobelEdgesExpert(BasicExpert):
    ...
    def apply_expert_batch(self, batch_rgb_frames):
        ...
        # blurred_old = torch.nn.functional.conv2d(batch_rgb_frames,
        #                                          self.g_filter_value,
        #                                          padding=self.win_size //
        #                                          2).float()
        # sx_old = torch.nn.functional.conv2d(blurred,
        #                                     self.sobel_filter_value,
        #                                     padding=1)
        # sy_old = torch.nn.functional.conv2d(blurred,
        #                                     self.sobel_filter_value.permute(
        #                                         (0, 1, 3, 2)),
        #                                     padding=1)
