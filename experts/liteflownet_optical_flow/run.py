...
import PIL.Image
import sys
import experts.liteflownet_optical_flow.correlation as correlation
'''
try:
...
def estimate(tenFirst, tenSecond, model_path):
	global netNetwork

	if netNetwork is None:
		netNetwork = Network(model_path).cuda().eval()
	# end
...
if __name__ == '__main__':
	...
	model_path = r'/root/code/mdg_load_experts/liteflownet_optical_flow/models/liteflownet-default'
	tenOutput = estimate(tenFirst, tenSecond, model_path)
